...
/**
 * Clase Record: en esta clase se encuentran todos los elementos que forman las
 * ventanas de record en cada una de las diferentes dificultades.
 *
 * @author Sergio Morán
 * @author Angel Ponce
 */
public class Record {
    ...
    /**
     * *
     * Metodos records: Aqui se genera la ventana del record y los botones de
    ...
    /**
     * *
     * Metodo eventoClick: aqui se hace el llamado a la acción que sucedera una
     * vez se clica sobre cada boton
     */
    public void eventoClick() {
        facil.addMouseListener(new MouseAdapter() {
            /**
             * *
             * Metodo mousePressed: se indica las acciones a realizar al tocar
             * el boton.
             *
             * @param e Este parametro es el que indica cuando se a clicado
             * sobre el boton.
             */
    ...
    /**
     * *
     * Metodo listado: aqui se almacenan los nombres, dificultades y records de
     * cada uno de los jugadores
     *
     * @param categoria Recibe el parametro categorias para poder saber a que
     * espacio mandarlo.
     */
    public void listado(int categoria) {
        ...
        switch (categoria) {
            ...
            case 0:
                sort(jugadoresFacil, jugadoresFacilSort);
                ...
                break;
            case 1:
                sort(jugadoresMedio, jugadoresMedioSort);
                ...
                break;
            case 2:
                sort(jugadoresDemente, jugadoresDementeSort);
    ...
    /**
     * *
     * Metodo leerRecords: en este metodo se ordenan a los jugadores dependiendo
     * de la dificultad en la que hallan jugado.
     */
    ...
    /**
     * *
     * Metodo sort: en este metodo se ardenan los jugadores por el punteo y la
     * dificultad donde se encuentran.
     *
     * @param tipoJugadores Se recibe el parametro tipoJugadores para saber en
     * que categoría se jugo.
     * @param tipoJugadores2 Se recibe el parametro tipoJugadores2 para
     * remplazar la categoría pero ya ordenada.
     */
