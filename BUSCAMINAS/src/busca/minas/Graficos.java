 ...
 * En esta clase se almacena el corazón del juego, se inicializa la ventana de
 * juego con todas sus propiedades. También se establecen todas las reglas y
...
public class Graficos extends JFrame {
    ...
    /**
     * *
     * Metodo Crear Ventana: Este método crea la ventana de juego con todas las
     * propiedades ya listas.
     */
    public void crearVentana() {
        ...
        botonSalir.addMouseListener(new MouseAdapter() {
            ...
            /**
             * *
             * Método mousePressed: Nos serivira para dar los eventos del click
             * al botón "Salir" de la ventana de juego. Según el el retorno del
             * método isBoton(); del objeto bot, el botón cerrara la ventana
             * principal o regresará al menú de inicio. El retonro del método
             * isBoton es booleano y si su valor es true, significa que el
             * usuario ha perdido o ha ganado la partida.
             */
    ...
    /**
     * *
     * Método crearCuadricula: Este método nos crea una cuadricula de JLabels
     * tal que sea la parte interna del juego, en donde iran los números y las
     * minas ocultas.
     */
    ...
    /**
     * *
     * Método crearBotones: El método que crea una cuadricula identica a la de
     * Labels del método crearCuadricula(); En lugar de ser Labels ahora son
     * botones, para que el jugador pueda ir presionando la cuadricula. Esta
     * nueva cuadricula esta repintada sobre los Labels, de manera que los
     * oculte.
     */
    ...
    /**
     * *
     * Método eventoClick: Esté metodo asigna el evento click para todos los
     * botones creados en el método crearBotones(); a cada botón le da la
     * propiedar correspondiente para que el juego funcione correctamente.
     */
    public void eventoClick() {
        ...
        for (JButton iterador : listaBotones) {
            MouseListener click = new MouseListener() {
                ...
                /**
                 * *
                 * Evento mouseClicked: Se sobre escriben los métodos del
                 * MouseListener para todos los botones. (Solo se utiliza el
                 * método mosueClicked).
                 */
    ...
    /**
     * *
     * Método dibujarMinas: El método reemplaza los labeles de texto por labeles
     * de imagén que contienen una bomba. Las posiciones que elige para el
     * intercambio están dadas por números aleatorios entre 0 y 440.
     *
     * @param dificultad El parámetro difiultad le indica al método cuantas
     * minas dibujar en la cuadricula.
     */
    ...
    /**
     * *
     * Método buscarMinasREpetidas: Este método es de gran útilidad ya que
     * establece que ninguna mina quede en lugares repetidos lo que asegura que
     * se dibujen todas las minas.
     */
    ...
    /**
     * *
     * Método encontrarMinas: Este método es llamado por el evento click de
     * todos los botones, lo que hace es que dependiendo de la úbicacion en
     * donde se generó un click busca y determina si existe una mina o no.
     *
     * @param pos El parámetro pos sirve para saber en que posicion se genero el
     * click y para ver si en esa posición hay una mina o no.
     * @return El retorno de este método es booleano, y si encuentra que la
     * posición donde se generó el click es una mina retorna el valor: true, en
     * caso contrario retorna el valor: false.
     */
    ...
    /**
     * *
     * Método algoritmoCruz: Este metodo estudia las posiciones en cruz de un
     * cuadro donde se genere un click y revisa si hay minas en esas posiciones.
     *
     * @param i2 parametro es la posiocion en la cuadricula donde se genera
     * click.
     * @return es un valor correspondiente a la cantidad de minas al rededor de
     * donde se origino el click
     */
    ...
    /**
     * *
     * Método trifuersa: El algoritmo trifuersa es el más importante de todos,
     * aquí es donde yace la base fundamental del juego. Este algoritmo
     * establecera las posiciones "Arriba", "Abajo", "Izquierda" y "Derecha" al
     * rededor de un botón (en donde se genera el click). A partir de estas
     * posiciones hace llamado del método trifuersa(); para saber si hay minas
     * en esas posiciones. Si encuentra una cantidad de minas mayor a 0 manda
     * impresión de la cantidad de minas encontradas en el label úbicado debajo
     * del botón donde se generó el click. Si encuentra que la cantidad de minas
     * es igual a 0 se vuelve recursivo y dentro de el mismo hace llamado al
     * método trifuersa() para proceder con el mismo procedimiento pero con las
     * posciciones "Arriba", "Abajo", "Izquierda" y "Derecha", es decir, ahora
     * buscará minas al rededor de 4 botones. Además, si la cantidad de minas al
     * rededor (cruz) de un botón es 0, el algoritmo le regalará esas posiciones
     * al jugador, para ahorrarle clicks inncesarios. Todo acaba justo cuando el
     * algoritmo detecta que hay al menos una mina.
     *
     * @param i2
     */
    ...
    /**
     * *
     * Método algoritmoWin: Este método estudia todas las posiciones de los
     * botones, este método es llamado por el evento click de los botones.
     *
     * @return Si el método irá sumando todas las posiciones de botones
     * restantes por precionar, el método en cada click retorna está cantidad,
     * si se detecta que la cantidad de botones restantes por precionar es la
     * misma cantidad de minas existentes se establece que el jugador ganó la
     * partida.
     */
    ...
    /**
     * *
     * Método puntajeTotal: esté método irá sumando la cantidad de clicks hechos
     * por el usuario, incluyendo los que el algoritmo trifuersa() regala.
     *
     * @return El retorno es la cantidad que el jugador lleva, sirve para
     * imprimirlo en la ventana de juego. También sirve para enviar ese punteo a
     * la lista de records.
     */
    ...
    /**
     * *
     * Método getNombre:Sirve para obtener el nombre del jugador, en cualquier
     * clase del proyecto.
     *
    ...
    /**
     * *
     * Método setNombre: Es útilizado por la clase "Emergentes" y envía un
     * cambio de nombre.
     *
     * @param aNombre Recibe el parámetro aNombre, para hacer el cambio de
     * atributo.
     */
    ...
    /**
     * *
     * Método getDificultad: Es utlizado por obras clases para obtener la
    ...
    /**
     * *
     * Método setDificultado: Es utilizado por la clase "Emergentes" y envía el
     * cambio de dificultad.
     *
     * @param aDificultad El parámetro aDificultad sirve para hacer el cambio de
     * atributo.
     */
    ...
    /**
     * *
     * Método exit: Es utilizado por la clase "Emergentes" y lo que indica es el
     * cierre de la ventana de juego. Se utiliza cuando el jugador ya perdió o
     * ganó.
     */
    public void exit() {
        ventana.dispose();
    ...
    /**
     * *
     * Método isBoton: Este método sirve para obtener el valor de la variable
     * boton, utilizada por el botón "Salir" de la ventana de juego.
     *
     * @return Retorna el valor de la variable boton.
     */
    ...
    /**
     * *
     * Método setBoton: Es utilizado por la clase "Emergentes" y le indica al
     * boton "Salir" si puede o no puede efectuar el método de regresar al menú
     * de inicio.
     *
     * @param aBoton Recibe el parámetro aBoton para que la clase "Emergentes"
     * envíe True o False.
     */
