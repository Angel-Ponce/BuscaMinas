...
/**
 * Clase Menu2: en esta clase se encuenta toda la estructura de la segunda
 * pantalla, en la cual se encontraran los botones de las dificultades y el
 * boton que nos dirige hacia la vantana de records
 *
 * @author Sergio Morán
 * @author Angel Ponce
 */
public class Menu2 {
    ...
    /**
     * *
     * Metodo Menu: aquí se colocaron todos los componentes que forman nuestra
     * ventana.
     */
    public void menu() {
    ...
    /**
     * *
     * Metodo eventosmenu: aquí se hace el llamado a las acciones del metodo
     * mousePressed.
     */
    public void eventosmenu() {
        ...
        boton[0].addMouseListener(new MouseAdapter() {
            ...
            /**
             * *
             * MetodomousePressed: este metodo llama a las acciones del click
             * cuando se presione sobre el boton "FÁCIL".
             *
             * @param e Recibe el parametro e el cual le indica que debe
             * realizar la acción una vez se apriete el boton.
             */
        ...
        boton[1].addMouseListener(new MouseAdapter() {
             ...
             * *
             * MetodomousePressed: este metodo llama a las acciones del click
             * cuando se presione sobre el boton "MEDIO".
             *
             * @param e Recibe el parametro e el cual le indica que debe
             * realizar la acción una vez se apriete el boton.
             */
        ...
        boton[2].addMouseListener(new MouseAdapter() {
             ...
             * *
             * MetodomousePressed: este metodo llama a las acciones del click
             * cuando se presione sobre el boton "DEMENTE".
             *
             * @param e Recibe el parametro e el cual le indica que debe
             * realizar la acción una vez se apriete el boton.
             */
     ...
     *
     * @param h Recibe el parametro h el cual nos indica el punteo del jugador
     * ingresado.
     */
    ...
    /**
     * *
     * Metodo agregarJugador: aquí se le manda los nombres ingresados a un .txt
     * para luego poder usarlos en la clase record.
     *
     * @param nombre Recibe el parametro nombre que nos indica el nombre del
     * jugador ingresado.
     * @param dificultad Recibe el parametro dificultad que nos indica la
     * dificultad del jugador ingresado.
     * @param score Recibe el parametro score que nos indica el score del
     * jugador ingresado.
     * @return Retorna la variable nombre hacia la clase record.
     */
     ...
     *
     * @return the dificultad Retorna la variable dificultad hacia la clase
     * Record
     */
     ...
     *
     * @param dificultad the dificultad to set Recibe el parametro dificultad,
     * para alamacenarlo en otra vareable.
     */
